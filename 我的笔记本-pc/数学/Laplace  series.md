...
$$
=a+\sum_k^n\frac{y^k}{k!}\frac{\mathrm{d}^{k-1}}{\mathrm{d}a^{k-1}}\left[\varphi^k(a)\right]+\frac1{n!}\int_0^y(y-t)^n\frac{\mathrm{d}^n}{\mathrm{d}a^n}\left[\varphi^{n+1}(x)\frac{\partial x}{\partial a}\right]_{y=t}\mathrm{d}t
$$
...
[[Legendre polynomial]]
$$
\frac1{\sqrt{1-2xt+t^2}}=\sum_{n=0}^{\infty}P_n(x)t^n\\y=\frac{1-\sqrt{1-2xt+t^2}}t\Rightarrow y=x+t\left(\frac{y^2-1}2\right)\\y=x+\sum_{n=1}^\infty\frac{t^n}{n!}\frac{d^n}{dx^n}\left[\left(\frac{a^2-1}2\right)^n\right]\\\frac1{\sqrt{1-2xt+t^2}}=\sum_{n=0}^\infty\frac{t^n}{2!2^n}\frac{d^n}{dx^n}\left(x^2-1\right)^n\Rightarrow P_n\left(x\right)=\frac1{n!2^n\:dx^n}\left(x^2-1\right)^n
$$
