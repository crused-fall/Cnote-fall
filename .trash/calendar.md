...
![how-to-close](chrome-extension://cbgfjbdckbpenliighcjcbjfiihnnkfe/images/how-to-close.png)
...
![how-to-reopen](chrome-extension://cbgfjbdckbpenliighcjcbjfiihnnkfe/images/how-to-reopen.png)
...
![how-to-pin](chrome-extension://cbgfjbdckbpenliighcjcbjfiihnnkfe/images/how-to-pin.png)
...
![how-to-weekend](chrome-extension://cbgfjbdckbpenliighcjcbjfiihnnkfe/images/how-to-weekend.png)
...
- **Template:** Configure a template for weekly notes. Weekly notes have slightly different template tags than daily notes. See here for the list of supported [weekly note template tags](chrome-extension://cbgfjbdckbpenliighcjcbjfiihnnkfe/#template-tags).
...
| Tag            | Description                                                                                                                                                                                                  |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 星期 1-7         | Because weekly tags refer to main days, you can refer to individual days like this `{{sunday:gggg-MM-DD}}` to automatically insert the date for that particular day. Note, you must specify the date format! |
